	...
	<div id="primary">
		...
		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                <div class="calendar"><iframe src="http://www.google.com/calendar/embed?src=laure_annev%40yahoo.co.uk&amp;title=&nbsp;&amp;height=600&amp;wkst=1&amp;bgcolor=%23ffffee&amp;color=%23666699&amp;ctz=Europe%2FAmsterdam" style=" border-width:0 " width="640" height="600" frameborder="0" scrolling="no"></iframe></div>
