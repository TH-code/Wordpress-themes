...
$(document).ready(function () {
    ...
    var // Too long on purpose. Point table, unreadable anyway, [x,y,r]
        ...
        gs = 6, // grid size
        dx = 230, // grid base
        dy = -300 + logoHeight, // grid base
        dz, ax, ay, az, dox, doy, dd, d, i, x, y, r, c, clr, ctx,
        pt, point, pointsLength, pointCollection,
        rb = 1, // radius base
        rs = 0.1, // radius step
        cf = 3; // color factor
    ...
    function onMove(e) {
        if (pointCollection) {
            pointCollection.mousePos.set(e.pageX - (($(window).width() - 1000) / 2), e.pageY);
        }
    }
