	...
	<div id="primary">
		...
		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
			...
			<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                <div class="shop"><iframe src="http://www.shirtcity.com/myshirtshop/merchandising/953109/t-shirtshop.html/set_language=en&set_country=NL" frameborder="0" width="620" height="1075"></iframe></div>
